...
import { Users, UserCheck, Settings, LogOut, Menu, X, Calendar } from "lucide-react"
import Link from "next/link"

interface AdminLayoutProps {
  children: React.ReactNode
  activeTab: "teams" | "judges" | "schedule" | "settings"
}
...
export function AdminLayout({ children, activeTab }: AdminLayoutProps) {
  ...
  const navigation = [
    { id: "teams", label: "Quản lý đội thi", icon: Users, href: "/admin/teams" },
    { id: "judges", label: "Quản lý ban giám khảo", icon: UserCheck, href: "/admin/judges" },
    { id: "schedule", label: "Quản lý lịch thi", icon: Calendar, href: "/admin/schedule" },
